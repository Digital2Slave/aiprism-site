...
本文运用opencv函数cornerEigenValsAndVecs来查找eigenvalues和eigenvectors判断像素点是否为角点。

运用opencv函数cornerMinEigenVal查找检测角点的最小值。
...
![](../assets/images/22c71e4a4e499113.png)

![](../assets/images/fce06ce2f2db5861.png)

![](../assets/images/115126134f3575b4.png)
```