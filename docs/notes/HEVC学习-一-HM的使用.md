...
最后，就是真正地编译HM工程了。从运行环境来讲，既可以在linux系统下使用makefile对HM进行编译，也可以在windows系统下使用IDE如VS对HM进行编译。我个人是用VS2008作为开发环境，因此，这里也只介绍使用VS编译HM。关于linux下如何进行，请参看前面提到的参看软件手册吧 <!-- image skipped: http://static.blog.csdn.net/xheditor/xheditor_emot/default/smile.gif --> ![微笑](http://static.blog.csdn.net/xheditor/xheditor_emot/default/smile.gif)。
...
原文来自：http://blog.csdn.net/hevc_cjl/article/details/8169182  