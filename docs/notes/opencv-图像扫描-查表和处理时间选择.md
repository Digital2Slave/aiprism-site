...
```cpp
    ...
    int main( int argc, char* argv[])
    {
        ...
        Mat I, J;
        if( argc == 4 && !strcmp(argv[3],"G") )//argc==4并且argv[3]='G'
            //I = imread(argv[1], CV_LOAD_IMAGE_GRAYSCALE);
            I = imread("G:\\basketballdrill0.bmp",0);//灰度图
        else
            //I = imread(argv[1], CV_LOAD_IMAGE_COLOR);
            I = imread("G:\\basketballdrill1.bmp",1);//彩色图

        if (!I.data)
        {
            //cout << "The image" << argv[1] << " could not be loaded." << endl;
            cout << "The image" << "G:\\basketballdrill0.bmp" << " could not be loaded." << endl;
            return -1;
        }
...
![](../assets/images/abd34d99bcaed594.png)

  


![](../assets/images/b3c483f52ee6a59e.png)  
